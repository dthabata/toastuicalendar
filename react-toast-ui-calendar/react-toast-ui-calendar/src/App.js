...
const schedules = [
  {
    id: '1',
    title: 'Dia do desenvolvedor',
    calendarId: '1',
    category: 'time',
    attendees: ['Datas comemorativas'],
    isVisible: true,
    start,
    end,
  },
  ...
  {
    id: '3',
    title: 'Vídeo de depoimento com Sidnei Marciano',
    calendarId: '3',
    category: 'time',
    attendees: ['GDTV'],
    isVisible: true,
  ...
  {
    id: '4',
    title: '100 curtidas no vídeo postado',
    calendarId: '4',
    category: 'time',
    attendees: ['Meta de posts'],
    isVisible: true,
    start: new Date(new Date().setHours(start.getHours() + 2)),
